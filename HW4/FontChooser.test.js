...
it('font size should initially be hidden', () => {
	const wrapper = mount(<FontChooser min='2' size='6' max='10' bold='false' text='hello' />);
...
it('font size should match initial value', () => {
	const wrapper = mount(<FontChooser min='2' size='8' max='10' bold='false' text='hello' />);
...
it('font size should turn red when value reaches max', () => {
	const wrapper = mount(<FontChooser min='2' size='9' max='10' bold='false' text='hello' />);
...
it('font size should turn red when value reaches min', () => {
	const wrapper = mount(<FontChooser min='3' size='4' max='10' bold='false' text='hello' />);
...
it('font size value should revert to default when double-clicked', () => {
	const wrapper = mount(<FontChooser min='3' size='6' max='10' bold='false' text='hello' />);
...
it('increase button should increment displayed font size when clicked', () => {
	const wrapper = mount(<FontChooser min='2' size='4' max='10' bold='false' text='hello' />);
...
it('increase button should not exceed max when clicked', () => {
	const wrapper = mount(<FontChooser min='3' size='9' max='10' bold='false' text='hello' />);
	wrapper.find('#increaseButton').simulate('click'); // now it's 10
...
it('checkbox should initially be checked when bold is true', () => {
	const wrapper = mount(<FontChooser min='2' size='6' max='10' bold='true' text='hello' />);
...
it('text should have correct value from props', () => {
	const wrapper = mount(<FontChooser min='2' size='6' max='10' bold='false' text='helloworld!' />);
	expect(wrapper.find('#textSpan').html().replace(/<[\s\S]*?>/g, '').trim()).to.equal('helloworld!');
    });

it('text should have correct initial font size', () => {
	const wrapper = mount(<FontChooser min='2' size='18' max='30' bold='false' text='hello' />);
